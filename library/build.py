...
JS_SRC_DIR       = SRC_DIR + ['js', 'micro']
HTML_SRC         = SRC_DIR + ['index.html']
CSS_SRC          = SRC_DIR + ['css', 'micro.css']
JS_SOURCES       = [
  ['micro.js'],
  ['types.js'],
  ['string.js'],
...
def build_examples():
    ...
    if mtimetree(EXAMPLE_SRC) > mtimetree(EXAMPLE_DIR):
...
def main(args):
    ...
    if mtime(SRC_DIR + ['app', 'main.default.js']) > mtime(TEMPLATE_APP_DIR + ['main.js']):
        copy(SRC_DIR + ['app', 'main.default.js'], TEMPLATE_APP_DIR + ['main.js'])
