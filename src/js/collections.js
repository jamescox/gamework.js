...
(function (exports) {
  ...
  exports.install = function (ns) {
    ns.foreach = function (fn, col) {
      var key, i, coltype = gamework.types.gettype(col);
    ...
    ns.map = function (fn, col) {
      var ret, key, i, coltype = gamework.types.gettype(col);
    ...
    ns.makezeroarray = function (/* dim1, dim2... */) {
      ...
      return gamework.collections.makearray.apply(this, [makezero].concat(args));
    };
    ...
    ns.makenullarray = function (/* dim1, dim2... */) {
      ...
      return gamework.collections.makearray.apply(this, [makenull].concat(args));
    };
    
    
    ns.len = function (col) {
      var coltype = gamework.types.gettype(col);
      
      if ((coltype === 'string') || (coltype === 'array')) {
        return col.length;
      } else if (coltype === 'object') {
        return gamework.collections.reduce(function (a) { 
          return a + 1; 
        }, 0, col);
      }
    };
    ...
    ns.keys = function (col) {
      var key, coltype = gamework.types.gettype(col), keys = [];
      
      if ((coltype === 'array') || (coltype === 'string')) {
        return gamework.collections.makearray(gamework.math.identity, col.length);
      } else if (coltype === 'object') {
        for (key in col) {
          if (col.hasOwnProperty(key)) {
            keys.push(key);
    ...
    ns.values = function (col) {
      var key, coltype = gamework.types.gettype(col), values = [];
    ...
    ns.isempty = function (col) { 
      return gamework.collections.len(col) === 0; 
    };
    
    ns.haskey = function (col, key) { 
      return gamework.collections.keys(col).indexOf(key) !== -1;
    };
    
    ns.contains = function (col, value) {
      return gamework.collections.values(col).indexOf(value) !== -1;
    };
  };
              
  exports.install(exports);
}(gamework.collections)); 
