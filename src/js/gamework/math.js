...
(function (exports) {
  ...
  exports.install = function (ns) {
    ...
    ns.vector = function (arg1, arg2) {
      ...
      if (typeof(arg1) !== 'undefined') {
        if (typeof(arg2) !== 'undefined') {
          ...
          if ((gamework.types.gettype(arg1) === 'array') && (arg1.length === 2)) {
            // Two element array.
            arg2 = arg1[1];
            arg1 = arg1[0];
    ...
    ns.randompick = function (col) {
      var keys, coltype = gamework.types.gettype(col);
      
      if ((coltype === 'string') || (coltype === 'array')) {
        return col[gamework.math.randomint(col.length - 1)];
      } else if (coltype === 'object') {
        keys = gamework.collections.keys(col);
        
        return keys[gamework.math.randomint(keys.length - 1)];
      }
    };
    ...
    ns.sum = function (/* [collection<number> | number...] */) {
      var args     = Array.prototype.slice.call(arguments), 
          arg0type = gamework.types.gettype(args[0]);
      ...
      if (args.length === 0) {
        ...
        if (arg0type === 'number') {
          ...
          return gamework.collections.reduce(function (acc, value) {
            return acc + value;
          }, 0, args[0]);
        } else {
          return +args[0];
    ...
    ns.mean = function (/* [collection<number> | number...] */) {
      ...
      if (args.length === 0) {
        ...
        if (arg0type === 'number') {
          ...
          return gamework.math.sum(args[0]) / gamework.collections.len(args[0]);
        } else {
          return +args[0];
        }
      } else {
        return gamework.math.mean(args);
      }
    };
    ...
    ns.normal = function (n) {
      return n === 0 ? 0 : n / gamework.math.abs(n);
    };
